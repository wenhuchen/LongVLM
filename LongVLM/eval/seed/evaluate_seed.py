...
ds_collections = {
    'SEEDv1': {
        'root': 'dataset/tSEED/',
        'annotation': 'dataset/tSEED/seed.jsonl',
        'max_new_tokens': 100,
        'min_new_tokens': 1,
    },
}
    ...
    for ds_name in args.datasets:
        ...
        if args.rope_pos_id_version == 'default':
            ...
            def newposid_collate_fn(batches, tokenizer):
                ...
                return pixel_values, questions, answers, indexes, num_tiles, all_boxes, orig_sizes, image_list
            ...
            outputs = []
            for _, (pixel_values, questions, answers, indexes, num_tiles, all_boxes, orig_sizes, image_list) in enumerate(tqdm(dataloader)):
                pixel_values = pixel_values.to(torch.bfloat16).cuda()
                generation_config = dict(
                    num_beams=args.num_beams,
                    max_new_tokens=ds_collections[ds_name]['max_new_tokens'],
...
if __name__ == '__main__':
    ...
    if args.rope_pos_id_version !='default':
        ...
        MultipleChoiceDataset.__getitem__ = __getitem__
