    ...
    for ds_name in args.datasets:
        ...
        if args.rope_pos_id_version == 'default':
            ...
            def newposid_collate_fn(batches, tokenizer):
                ...
                return pixel_values, questions, question_ids, annotations, num_tiles, all_boxes, orig_sizes, image_list
            ...
            outputs = []
            for _, (
            pixel_values, questions, question_ids, annotations, num_tiles, all_boxes, orig_sizes, image_list) in tqdm(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasets', type=str, default='okvqa_val,textvqa_val,vizwiz_val,ai2diagram_test,gqa_testdev_llava')
    ...
    if args.rope_pos_id_version != 'default':
        ...
        def __getitem__(self, idx):
            all_boxes, num_tiles, image_list, orig_sizes = [], [], [], []
            data = json.loads(self.test[idx].strip())
            image, question, question_id, annotation = data['image'], data[
                'question'], data['question_id'], data.get('answer', None)
            ...
            if self.dynamic_image_size:
                images, boxes = dynamic_preprocess(image, image_size=self.input_size,
                                                   use_thumbnail=self.use_thumbnail,
        ...
        VQADataset.__getitem__ = __getitem__
